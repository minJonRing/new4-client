...
export default {
    ...
    computed: {
        ...mapGetters(['bookType', 'bookTypeJson', 'collectTopic']),
    },
    watch: {
        collectTopic() {
            this.handleSearch()
    ...
    methods: {
        ...
        tableFilter(param) {
            ...
            return {
                initTable: initTable.filter(({ name: _title, docType: _docType }) => {
                    let isT = true;
                    let isD = true;
